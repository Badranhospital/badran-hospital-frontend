    ...
    <section className="py-9 md:py-20 bg-linear-to-b from-[#E0F7FA] to-[#B2EBF2]">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-8 md:mb-12">
          <p className="text-[#388AA3] text-lg font-medium mb-2 uppercase tracking-wide">
            {dict.subtitle}
          </p>
        ...
        {/* Thumbnails */}
        <div className="max-w-4xl xl:max-w-5xl 2xl:max-w-7xl mx-auto">
          <div
            className={cn(
              "flex gap-3 md:gap-4 overflow-x-auto scrollbar-hide py-4 px-4 md:px-0 snap-x",
              lang === "ar"
          ...
          >
            {galleryImages.map((image, index) => (
              <button
                ...
                className={cn(
                  "relative shrink-0 w-24 md:w-32 aspect-square rounded-lg overflow-hidden transition-all duration-300 border-2 snap-center",
                  current === index
